...
public class CommandInvoiceTest
{
    ...
    public void Setup()
    {
        ...
        _sandwich1 = new Sandwich("sandwich1",
            ...
            {
                { ing1, new Quantity(QuantityUnit.Gram, 10) }, { ing2, new Quantity(QuantityUnit.Slice, 0.5) },
                { ing3, new Quantity(QuantityUnit.Unit, 0.1) }
            });
        _sandwich1Price = new Price(Currency.Euro, 2.3);
        _sandwich2 = new Sandwich("sandwich2",
            new Dictionary<Ingredient, Quantity>
            {
                { ing4, new Quantity(QuantityUnit.Gram, 15) }, { ing2, new Quantity(QuantityUnit.Slice, 2) },
                { ing3, new Quantity(QuantityUnit.Unit, 3) }
            });
